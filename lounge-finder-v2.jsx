      ...
      <div className="lf2-page">
          ...
          <div className="lf2-header-inner">
            ...
            <span className="lf2-header-label">
              {selCity
                ...
                : <span className="lf2-header-meta">Select a city to find lounges</span>
              }
            </span>
          </div>
        </header>
        ...
        <main className="lf2-main">
          ...
          <section className="lf2-hero-simple">
            <div className="lf2-hero-eyebrow-simple">Lounge directory</div>
        ...
        <footer className="lf2-footer">Elite Assist · Lounge directory</footer>
      </div>
    );
  }
